...
- `apps/scanledger/src/falcoria_scanledger/projects/dependencies.py#validate_project_access` — the single membership/admin gate mounted on both `ips_router` and `history_router`. Open when changing project-level authorization.
